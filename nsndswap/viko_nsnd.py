...
nsnd = {
    ...
    "Chill": [],
    "Thundersnail": [],
    "Temmie Village": ["Enemy Approaching"],
    "Tem Shop": ["Enemy Approaching"],
    ...
    "Hopes and Dreams": ["Once Upon a Time", "Your Best Friend"],
    ...
    "Bring It In, Guys!": ["Enemy Approaching", "Nyeh Heh Heh!", "sans.", "Snowy", "Undyne", "Ruins (Undertale)", "It's Showtime!", "Another Medium", "Bergentrückung", "Fallen Down", "Once Upon a Time"],
    "Last Goodbye": ["Once Upon a Time", "Ruins (Undertale)"],
